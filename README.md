...
setTimeout
Utilizado para executar uma função após um determinado período de tempo.

setInterval
Utilizado para executar uma função repetidamente em intervalos regulares.

clearInterval
Utilizado para interromper a execução de um intervalo previamente iniciado.
